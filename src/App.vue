...
<transition name="fade">
    <main class="wrapper ai-window" v-if="chatwindow">
        <br>
        <br>
        ...
        <table v-for="a in answers" class="chat-window">
            ...
            <tr>
                ...
                <img src='chatbot.png' width='45px' height='45px' class='circular--square' style='float: left;' />
    ...
    <div id="chaticondiv">
        <input v-on:click="chatwindow = !chatwindow" type="image" src="chatbot.png" width="50px" height="50px"  style="outline:none;border-radius: 25px;text-align: center;box-shadow: 10px 10px grey;    box-shadow: lightgrey -2px -2px;">
</div>
</section>
</template>
...
export default {
    ...
    data: function(){
        return {
            ...
            micro: false,
            chatwindow: config.locale.settings.chatwindowhide,
            chatwindowshow: config.locale.settings.chatwindowshow,
